...
#### Visualizing the Search Operation
...
```{dot}
//| label: fig-BST-Search
//| fig-cap: "Illustration of the search operation process in a binary search tree, comparing recursive and iterative approaches. The recursive path is shown in blue, while the iterative path is shown in green."
digraph BST {
  node [shape=circle];
  2 -> {1, 3}
  
  // Nodes in the path of the recursive search
  2 [color=blue];
  3 [color=blue];

  // Nodes in the path of the iterative search
  2 [color=green];
  3 [color=green];
}
```
...
#### Visualizing the Insertion Operation
...
```{dot}
//| label: fig-BST-Insert
//| fig-cap: "Illustration of the node insertion process in a binary search tree, showcasing both recursive and iterative approaches. The path followed by the recursive approach is shown in blue, while the path followed by the iterative approach is shown in green."
digraph BST {
  node [shape=circle];
  2 -> {1, 3}
  3 -> 4
